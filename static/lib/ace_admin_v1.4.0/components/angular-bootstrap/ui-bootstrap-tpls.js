...
angular.module("uib/template/pagination/pagination.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("uib/template/pagination/pagination.html",
    ...
    "  <li ng-repeat=\"page in pages track by $index\" ng-class=\"{active: module.active,disabled: ngDisabled&&!page.active}\" class=\"pagination-page\"><a href ng-click=\"selectPage(module.number, $event)\">{{module.text}}</a></li>\n" +
